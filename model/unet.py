...
class TextEncoder(nn.Module):
    ...
    def forward(self, text_input):
        # Tokenize input text
        encoded_input = self.tokenizer(text_input, 
                                       return_tensors='pt', 
                                       padding=True, 
                                       truncation=True)
        # Get BERT model ouput
...
class UNet(nn.Module):
    ...
    def __init__(self,
                 in_channels,
                 text_input_dim, # Dimensionality of text input
                 vocab_size, # Vocabulary size for text input
    ...
    def forward(self, sample, timesteps, text_input):
        ...
        # Encode text_input using text embedding
        text_represetnation = self.text_encoder(text_input)
